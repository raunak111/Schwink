  ...
  List<Widget> usernameAndPassword() {
    return [
      padded(
        ...
        key: new Key('email'),
        decoration: new InputDecoration(labelText: 'Email' ,icon:Icon( Icons.email,size: 30.0,)),
        autocorrect: false,
      ...
      padded(
        ...
        decoration: new InputDecoration(labelText: 'Password',icon: Icon(Icons.vpn_key, size: 30.0,)),
        obscureText: true,
        autocorrect: false,
